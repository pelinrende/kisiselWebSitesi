                    ...
                    <div class="card message-card"
                        ...
                        <div class="card-body p-5">
                            <div class="text-center mb-5">
                                ...
                                <p style="color: #a29bfe; font-size: 0.9rem;">Seninle tanışmak için sabırsızlanıyorum!</p>
                            </div>
                            ...
                            <form action="{{ route('iletisim.gonder') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    <label
                                        ...
                                        Soyad</label>
                                    <input type="text" name="name" class="custom-input" placeholder="..." required>
                                </div>
                                ...
                                <div class="mb-4">
                                    <label
                                        ...
                                        Adresi</label>
                                    <input type="email" name="email" class="custom-input" placeholder="..." required>
                                </div>
