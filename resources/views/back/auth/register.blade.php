...
<head>
    ...
    <style>
        ...
        .card {
            ...
            border: none;
            box-shadow: 0 40px 80px rgba(32, 1, 47, 0.2);
            background: #ffffff;
        }
        ...
        .btn-register {
            ...
            font-weight: 900;
            text-transform: uppercase;
            background: linear-gradient(to right, #20012f, #4e73df);
            border: none;
            color: white;
            margin-top: 1rem;
            transition: 0.3s;
        ...
        <div class="card shadow-lg">
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h1>Yeni Hesap! 🚀</h1>
                    <p class="sub-text">Yönetim paneline katılmak için formu doldur.</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group mb-3">
                        <input type="text" name="name" class="form-control form-control-user"
                            placeholder="Ad Soyad" value="{{ old('name') }}" required autofocus>
                    </div>
                    ...
                    <button type="submit" class="btn btn-register btn-block shadow">
                        Kayıt Ol
                    </button>
                </form>
                ...
                <div class="footer-links text-center">
                    <a class="small-link" href="{{ route('login') }}">
                        Zaten hesabın var mı? <span style="color: #4e73df; font-weight: 900;">Giriş Yap</span>
                    </a>

                    <div class="back-to-site mt-3 pt-3 border-top">
